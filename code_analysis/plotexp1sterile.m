function [] = plotexp1sterile(data)
%PLOTEXP1STERILE produces supplementary control with sterile cooperators (exp1, mutation rate between 0.001 and 0.01)
...
pa=patch(0.013+saveh/2+[ini 0.125 0.125 0.25 0.25 0.375 0.375 0.25 0.25 ini ini]*(1-saveh), 0.011+savev/2+[0.25 0.25 0.375 0.375 0.5 0.5 0.75 0.75 1 1 0.25]*(1-savev),colorb2,'LineStyle','none');
