...
pb=line(0.013+saveh/2+[ini 0.125 0.125 0.625 0.625 fin fin 0.125 0.125 ini ini]*(1-saveh), 0.011+savev/2+[0.25 0.25 0.375 0.375 0.5 0.5 1 1 0.375 0.375 0.25]*(1-savev),'color',[0 1 0],'LineStyle',':');
pc=line(0.013+saveh/2+[ini fin fin 0.625 0.625 0.125 0.125 ini ini]*(1-saveh), 0.011+savev/2+[0 0 0.5 0.5 0.375 0.375 0.25 0.25 0]*(1-savev),'color',[1 0 0],'LineStyle',':');


%% Export and fix
print('-depsc','-loose','4fig1');