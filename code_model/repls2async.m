...
for a=1:nrep
  ...
  [secretion_nb(a,:),mutators_dc_nb(a,:),mutators_cd_nb(a,:),neutral_nb(a,:)]=s2async(baseseed+a,ngen,sizex,sizey,def_mutdc,def_mutcd,evo_mutdc,evo_mutcd,mut_mutcoop,mut_neutral,basefitness,cost,benefit,mexp,liquid,sterile,recordpath,record,false);
end
