...
for a=1:nrep
  ...
  [cooperation_nb(a,:),mutators_dc_nb(a,:),mutators_cd_nb(a,:)]=s2invasion(baseseed+a,ngen,sizex,sizey,def_mutdc,def_mutcd,evo_mutdc,evo_mutcd,basefitness,cost,benefit,mexp,liquid,raretype,recordpath,record,false);
end

save([psave '.mat'],'cooperation_nb','mutators_dc_nb','mutators_cd_nb',...
